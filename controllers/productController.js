...
export const getSingleProductController = async(req, res) =>{
  try{
    ...
    res.status(500).send({
      success:false,
      message:"cant take product singly",
      error,
  })
}}
...
export const searchProductController = async (req, res) => {
  try {
    ...
    console.error("Error in searchProductController:", error); // Log the full error
    res.status(500).send({
      success: false,
...
export const relatedProductController = async (req, res) => {
  try{
    ...
    .select("name description price slug photo")
    .limit(3)
